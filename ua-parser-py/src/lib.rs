...
type OSParser = (String, Option<String>, Option<String>, Option<String>, Option<String>, Option<String>);
#[pyclass(frozen)]
...
type DeviceParser = (String, Option<String>, Option<String>, Option<String>, Option<String>);
#[pyclass(frozen)]
    ...
    fn new(it: &PyAny) -> PyResult<Self> {
        ...
        it.iter()?
            .try_fold(Builder::new(), |s, p| {
                ...
                s.push(Parser {
                    regex: Owned(p.0),
                    regex_flag: if p.1.as_deref() == Some("i") { Some(Flag::IgnoreCase) } else { None },
